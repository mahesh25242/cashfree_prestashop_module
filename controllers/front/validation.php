...
class CashfreeValidationModuleFrontController extends ModuleFrontController
{
	...
	public function postProcess()
	{
		...
		*/
		...
		$this->module->validateOrder((int)$cart_id,  $status, (float)$orderAmount, $this->module->displayName, null, null, null, false, $customer->secure_key); //updating order status in order history of Prestashop
